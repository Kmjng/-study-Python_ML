...
# 3. axis 속성 
print(data2.sum(axis=0)) # 행 축 : 열 끼리 합계 
print(data2.sum(axis=1)) # 열 축 : 행 끼리 합계 
print('전체 원소 합계 :', data2.sum()) # 축 생략 : 전체 원소 합계 
'''
[ 0.75589311 -1.99547262  0.29821515 -0.7875729 ]
[-1.02174002  0.44040617 -1.14760341]
전체 원소 합계 : -1.728937267456667
'''
